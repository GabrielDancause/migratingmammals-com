...
data.forEach(city => {
  city.climate = climates[city.city] || null;
  // According to memory instructions: "always use null for missing values rather than generating fake or mocked data"
  city.coworkingMonthlyUSD = null;
  city.internetSpeedMbps = null;
  city.safetyRating = null;
  city.nomadScore = null;
});
